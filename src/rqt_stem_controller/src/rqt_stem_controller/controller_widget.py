...
class ControllerWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.supervise_button_layout.addWidget(QPushButton('TEST'))
        self.supervise_button_layout.addWidget(QPushButton('TEST2'))
        self.supervise_button_layout.addWidget(QPushButton('TEST3'))
